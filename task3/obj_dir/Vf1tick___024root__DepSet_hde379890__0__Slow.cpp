...
VL_ATTR_COLD void Vf1tick___024root___settle__TOP__0(Vf1tick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1tick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1tick___024root___settle__TOP__0\n"); );
    // Body
...
VL_ATTR_COLD void Vf1tick___024root___eval_initial(Vf1tick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1tick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1tick___024root___eval_initial\n"); );
    // Body
    vlSelf->__Vclklast__TOP__clk = vlSelf->clk;
}

VL_ATTR_COLD void Vf1tick___024root___eval_settle(Vf1tick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1tick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1tick___024root___eval_settle\n"); );
    // Body
    Vf1tick___024root___settle__TOP__0(vlSelf);
    vlSelf->__Vm_traceActivity[1U] = 1U;
    vlSelf->__Vm_traceActivity[0U] = 1U;
}

VL_ATTR_COLD void Vf1tick___024root___final(Vf1tick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1tick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1tick___024root___final\n"); );
}

VL_ATTR_COLD void Vf1tick___024root___ctor_var_reset(Vf1tick___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vf1tick__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vf1tick___024root___ctor_var_reset\n"); );
    // Body
    ...
    vlSelf->f1tick__DOT__clock__DOT__count = VL_RAND_RESET_I(16);
    vlSelf->f1tick__DOT__formula__DOT__current_state = 0;
    vlSelf->f1tick__DOT__formula__DOT__next_state = 0;
